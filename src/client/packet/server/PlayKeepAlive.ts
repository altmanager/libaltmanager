 ...
 *
 * @see {@link import("../client/PlayKeepAlive.ts").PlayKeepAlive}
 * @see {@link https://minecraft.wiki/w/Java_Edition_protocol/Packets#Clientbound_Keep_Alive_(play)|Clientbound Keep Alive}
 */
export class PlayKeepAlive extends KeepAlive {
  public static override readonly ID = 0x2b;
